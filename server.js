...
function onChatHandler(target, context, msg, self) {
  ...
  if (commandName === '!social') {
    client.say(target, `socials at www.twitter.com and www.discord.com`);
  }

  if (commandName === '!game') {
    client.action('Mohammed_is_sus1', 'Mohammed_is_sus1 is playing Genshin Impact');
  }
  ...
  if (msg.includes("hello") || msg.includes("HELLO")) {
    client.action('Mohammed_is_sus1', 'welcome to the chat, enjoy your stay :)');
  }
...
function onConnectedHandler(addr, port) {
  ...
  client.action('Saif', 'Hello Mohammed_is_sus1, lame bot here');
}